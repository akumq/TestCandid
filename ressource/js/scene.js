...
export class Scene {
  constructor(renderer, camera, gltfPath, srtPath = null, audioPath = null) {
  ...
  load() {
    return new Promise((resolve, reject) => {
      ...
      gltfLoader.load(this.gltfPath, (data) => {
        // Add model to scene
        ...
        object.traverse((child) => {
            ...
            this.cameraKeyFrames.push(new CamKeyFrame(position, rotation, child.userData.time, child.userData.duration));
            }
        });
  ...
  interpolateCamera() {
    ...
    if (gsap.isTweening(this.camera.rotation) || gsap.isTweening(this.camera.position)) {
      return;
    }
